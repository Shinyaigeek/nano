...
class Link extends component_1.Component {
    ...
    addPrefetch() {
        ...
        if (!doesAlreadyExist) {
            const prefetch = (0, core_1.h)('link', { rel: 'prefetch', href: this.props.href, as: 'document' });
    ...
    render() {
        ...
        if (prefetch === true && !(typeof window !== 'undefined' && window.document)) {
            ...
            const link = (0, core_1.h)('link', { rel: 'prefetch', href: this.props.href, as: 'document' });
            const helmet = (0, core_1.h)(helmet_1.Helmet, null, link);
            return (0, core_1.h)(fragment_1.Fragment, null, [helmet, a]);
        }
        // if not ssr
        else {
            return a;
