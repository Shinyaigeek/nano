...
class Switch extends component_1.Component {
    ...
    render() {
        ...
        if (child) {
            ...
            const el = (0, core_1._render)(child);
            return (0, core_1.h)('div', {}, (0, core_1._render)(el));
        }
        else if (this.props.fallback) {
            return (0, core_1.h)('div', {}, (0, core_1._render)(this.props.fallback));
        }
        else {
            return (0, core_1.h)('div', {}, 'not found');
        }
    }
}
...
const Link = ({ to, replace, children }) => {
    ...
    return (0, core_1.h)('a', { href: to, onClick: (e) => handleClick(e) }, children);
};
exports.Link = Link;
