...
class NavigationAction extends component_1.Component {
    ...
    render() {
        const label = (0, core_1.h)('span', { class: classes.label }, this.props.label);
        ...
        }, this.props.icon ? (0, core_1.h)(icon_1.Icon, { size: 22, style: 'margin-bottom: 2px;', src: this.props.icon }) : null, label);
    }
}
...
class Navigation extends component_1.Component {
    ...
    `;
        ...
        const navigation = (0, core_1.h)('div', { id: 'bottom_navigation_container' }, children);
        if (parentId) {
