...
class Snackbar {
    ...
    _show(options, callback) {
        ...
        const Snack = (_message, _actions) => {
            ...
            const message = (0, core_1.h)('div', { class: 'snackbar_message' }, _message);
            const actions = (0, core_1.h)('div', { class: 'snackbar_actions' }, actionsArray);
            const snack = (0, core_1.h)('div', { class: 'snackbar_snack' }, message, actions);
            return snack;
        };
