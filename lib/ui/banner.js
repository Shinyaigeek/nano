...
class Banner extends component_1.Component {
    ...
    top: ${sticky}px;`
        ...
        const bodyElement = (0, core_1.h)('div', { style: styles.body }, body);
        const actionsElement = (0, core_1.h)('div', { style: styles.actions }, actionsArray);
        const bannerElement = (0, core_1.h)('div', { style: styles.banner }, bodyElement, actionsElement);
        return (0, core_1.h)('div', { style: styles.container }, bannerElement);
    }
}
