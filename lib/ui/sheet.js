...
class Sheet extends component_1.Component {
    static show(sheet) {
        document.body.appendChild((0, core_1.render)(sheet));
    }
    static close() {
    ...
    render() {
        ...
        const cssHash = (0, core_1.strToHash)(`sheet${mode}`);
      ...
      .sheet_subtitle-${cssHash} {
        ...
        const background = (0, core_1.h)('div', {
            class: `sheet_background-${cssHash}`,
            onClick: () => {
                element.remove();
            }
        });
        const t = title ? (0, core_1.h)('div', { class: `sheet_title-${cssHash}` }, title) : null;
        const s = subtitle ? (0, core_1.h)('div', { class: `sheet_subtitle-${cssHash}` }, subtitle) : null;
        // @ts-ignore
        const sh = (0, core_1.h)('div', { class: `sheet_sheet-${cssHash}` }, t, s, this.props.children);
        const element = (0, core_1.h)('div', { class: `sheet_container-${cssHash}` }, background, sh);
        return element;
    }
}
exports.Sheet = Sheet;
