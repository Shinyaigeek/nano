    ...
    `;
        ...
        const navigationAction = menu
            ...
            : back
                ...
                : null;
        const navigation = navigationAction ? (0, core_1.h)('div', { class: 'toolbar_navigation_box' }, navigationAction) : null;
        const title = this.props.title ? (0, core_1.h)('div', { class: 'toolbar_title' }, this.props.title) : null;
        const left = (0, core_1.h)('div', { class: classes.left }, navigation, title);
        const right = (0, core_1.h)('div', { class: classes.right }, this.props.children);
        const bar = (0, core_1.h)('div', { class: classes.bar }, left, right);
        return bar;
    }
}
