...
class Icon extends component_1.Component {
    ...
    render() {
        ...
        this.cssHash = (0, core_1.strToHash)(active + color + size.toString());
        const colors = {
            active: color,
            inactive: '#00000070'
        };
    ...
    `;
        ...
        const icon = (0, core_1.h)('i', Object.assign(Object.assign({ class: classes.join(' ') }, rest), { style: iconStyle + style }));
        return icon;
    }
}
exports.Icon = Icon;
