    ...
    show(options, callback) {
        ...
        const Dialog = (_header, _body, _actions) => {
            const actionsArray = _actions.map((action) => {
                return (0, core_1.h)(button_1.Button, {
                    text: true,
            ...
            const title = (0, core_1.h)('h2', { class: 'dialog_header' }, _header);
            const body = (0, core_1.h)('div', { class: 'dialog_body' }, _body);
            const actions = (0, core_1.h)('div', { class: 'dialog_actions' }, actionsArray);
            const dialog = (0, core_1.h)('div', { class: 'dialog' }, title, body, actions);
            return dialog;
        };
