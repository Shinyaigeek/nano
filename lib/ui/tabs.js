...
const Tab = (props) => {
    ...
    const a = (0, core_1.h)('a', Object.assign({}, link), props.children);
    return (0, core_1.h)('li', { class: classes.join(' ') }, a);
};
exports.Tab = Tab;
class Tabs extends component_1.Component {
    ...
    render() {
        var _a;
        const ripple = (0, _config_1.rippleEffect)('#ffffff70', '#5902db');
        const { scroll = false, children, active } = this.props;
        const cssHash = (0, core_1.strToHash)(scroll.toString() + (children === null || children === void 0 ? void 0 : children.length) + active + ripple.class);
        const styles = `
      ...
      `;
        ...
        this.items = (0, core_1.render)(this.props.children);
        const list = (0, core_1.h)('ul', { class: `tabs_list-${cssHash}` }, this.items);
        this.line = (0, core_1.h)('div', { class: `tabs_line-${cssHash}` });
        const container = (0, core_1.h)('div', { class: `tabs_container-${cssHash}` }, list, this.line);
        return container;
    }
}
exports.Tabs = Tabs;
