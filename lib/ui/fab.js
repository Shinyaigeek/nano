...
class Fab extends component_1.Component {
    render() {
        ...
        const cssHash = (0, core_1.strToHash)(extended.toString() + mini.toString() + center.toString() + left.toString()); // Math.random().toString(36).substr(2, 9)
    ...
    `;
        ...
        return (0, core_1.h)('div', { class: className, onClick: (e) => onClick(e) }, children);
    }
}
exports.Fab = Fab;
