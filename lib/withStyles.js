...
const withStyles = (styles) => (WrappedComponent) => {
    return class extends component_1.Component {
        render() {
            ...
            const helmet = (0, core_1.h)(helmet_1.Helmet, null, (0, core_1.h)('style', null, styles.toString()));
            const component = children && children.length > 0
                ? (0, core_1.h)(WrappedComponent, Object.assign({}, rest), children)
                : (0, core_1.h)(WrappedComponent, Object.assign({}, this.props));
            return (0, core_1.h)(fragment_1.Fragment, null, helmet, component);
            // same in JSX
            // return (
            //   <Fragment>
            //     <Helmet>
